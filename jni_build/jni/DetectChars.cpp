...
///////////////////////////////////////////////////////////////////////////////////////////////////
bool loadKNNDataAndTrainKNN(cv::String classfile, cv::String imagefile) {
	...
	if (fsClassifications.isOpened() == false) {													// if the file was not opened successfully
		...
		LOGI("error, unable to open training classifications file, exiting program");
	...
	cv::FileStorage fsTrainingImages(imagefile, cv::FileStorage::READ);			// open the training images file

	if (fsTrainingImages.isOpened() == false) {													// if the file was not opened successfully
		//std::cout << "error, unable to open training images file, exiting program\n\n";			// show error message
		LOGI("error, unable to open training images file, exiting program");
		return(false);																				// and exit program
	}
